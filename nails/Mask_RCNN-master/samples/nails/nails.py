"""
Mask R-CNN
Train on the toy nails dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 nails.py train --dataset=/path/to/nails/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 nails.py train --dataset=/path/to/nails/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 nails.py train --dataset=/path/to/nails/dataset --weights=imagenet

    # Apply color splash to an image
    python3 nails.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 nails.py splash --weights=last --video=<URL or path to file>
"""
...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_nails_v1.h5")
...
class NailsDataset(utils.Dataset):
    ...
    def load_nails(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                labels = [r['shape_attributes']['name'] for r in a['regions'].values()]
            else:
                polygons = [r['shape_attributes'] for r in a['regions']]
                labels = [r['shape_attributes']['name'] for r in a['regions']]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a nails dataset image, delegate to parent class.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect nailss.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/nails/dataset/",
                        help='Directory of the nails dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(NailsConfig):
